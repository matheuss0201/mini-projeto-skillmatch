...
# O cálculo feito pelo sistema:
1. O sistema identifica que você possui *3 das 4* habilidades exigidas.
2. Faz a divisão: 3 / 4 = 0.75
3. Multiplica por 100 para obter a porcentagem: 0.75 * 100 = 75%.
...
---
## 👤 Autor
Desenvolvido por **Matheus** — Projeto prático de avaliação em JavaScript.